...
"[project]/frontend/node_modules/.pnpm/@utxorpc+sdk@0.6.8_@bufbuild+protobuf@1.10.1/node_modules/@utxorpc/sdk/lib/browser/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function metadataInterceptor(options) {
    return (next)=>async (req)=>{
            if (!!(options == null ? void 0 : options.headers)) {
                Object.entries(options.headers).forEach(([key, value])=>req.header.set(key, value));
            }
...
function pointToBlockRef(p) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sync"].BlockRef({
        index: BigInt(p.slot),
        hash: new Uint8Array(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f$buffer$40$6$2e$0$2e$3$2f$node_modules$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(p.hash, "hex"))
    });
}
function blockRefToPoint(r) {
    return {
        slot: r.index.toString(),
        hash: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f$buffer$40$6$2e$0$2e$3$2f$node_modules$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(r.hash).toString("hex")
    };
}
...
var SyncClient = class {
    constructor(options){
        ...
        this.inner = createPromiseClient(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["syncConnect"].SyncService, transport);
    }
    async *followTip(intersect) {
        const req = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sync"].FollowTipRequest({
    ...
    async fetchBlock(p) {
        ...
        const res = await this.inner.fetchBlock({
            ref: [
                req
            ]
        });
    ...
    async fetchHistory(p, maxItems = 1) {
        const req = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sync"].DumpHistoryRequest({
            startToken: p ? new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sync"].BlockRef({
                index: BigInt(p.slot),
                hash: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f$buffer$40$6$2e$0$2e$3$2f$node_modules$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(p.hash, "hex")
            }) : void 0,
            maxItems
        });
...
var QueryClient = class {
    constructor(options){
        ...
        this.inner = createPromiseClient(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["queryConnect"].QueryService, transport);
    }
    async readParams() {
...
var SubmitClient = class {
    constructor(options){
        ...
        this.inner = createPromiseClient(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["submitConnect"].SubmitService, transport);
    }
    async submitTx(tx) {
...
var WatchClient = class {
    constructor(options){
        ...
        this.inner = createPromiseClient(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["watchConnect"].WatchService, transport);
    }
    async *watchTxByMatch(pattern, intersect) {
        const request = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f2e$pnpm$2f40$utxorpc$2b$spec$40$0$2e$16$2e$0$2f$node_modules$2f40$utxorpc$2f$spec$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["watch"].WatchTxRequest({
...
//# sourceMappingURL=b2b8f_%40utxorpc_sdk_lib_browser_index_mjs_564444b5._.js.map